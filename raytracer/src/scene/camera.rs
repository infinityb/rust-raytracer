...
impl Camera {
    ...
    fn update_internal_sizes(&mut self) {
        ...
        let ratio = f64::from(self.image_height) / f64::from(self.image_width);
        ...
        self.pixel_width  = camera_width / f64::from(self.image_width  - 1);
        self.pixel_height = camera_height / f64::from(self.image_height - 1);
    }
}
