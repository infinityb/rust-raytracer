...
pub fn get_scene() -> Scene {
    ...
    lights.push(box SphereLight { position: Vec3 { x: 8.0, y: 8.0, z: 0.0 }, color: ColorRGBA::new_rgb(1.0, 0.8, 0.4), radius: 0.5 });
    lights.push(box SphereLight { position: Vec3 { x: 8.0, y: -5.0, z: 0.0 }, color: ColorRGBA::new_rgb(0.5, 0.4, 0.2), radius: 1.0 });
    lights.push(box PointLight { position: Vec3 { x: -16.0, y: -14.5, z: -2.0 }, color: ColorRGBA::new_rgb(0.15, 0.07, 0.05) });
